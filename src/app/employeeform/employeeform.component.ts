...
export class EmployeeformComponent implements OnInit {
  ...
  constructor(private http: HttpClient) {
    ...
    this.http.post(this.ip + '/api/skillsindemand', 'dara', {headers} ).subscribe(response => {
    this.skillsindemand = response;
    });
  ...
  form: FormGroup = new FormGroup({
    ...
    skillsindemand: new FormControl(''),
  ...
  onsubmit(value) {
    ...
    const headers = new HttpHeaders();
    headers.append('content-type', 'application/json');
    this.http.post(this.ip + '/api/jobseeker', data, {headers} ).subscribe(response => {
